...
#if defined(NDEBUG)
#error "remita cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uremita) are considered zero fee (for relaying, mining and transaction creation)
...
bool RecalculateREMITSupply(int nHeightStart)
{
	AssertLockHeld(cs_main);
	...
	uiInterface.ShowProgress(_("Recalculating REMIT supply..."), 0);
	while (true) {
		if (pindex->nHeight % 1000 == 0) {
			LogPrintf("%s : block %d...\n", __func__, pindex->nHeight);
			int percent = std::max(1, std::min(99, (int)((double)((pindex->nHeight - nHeightStart) * 100) / (chainHeight - nHeightStart))));
			uiInterface.ShowProgress(_("Recalculating REMIT supply..."), percent);
		}
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 1) {
        ...
        nSubsidy = 1200.5 * COIN;
    } else if (nHeight <= 510000) {
        nSubsidy = 1000.5 * COIN;
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue)
{
    ...
    if (nHeight <= 1000) { 
        ...
        mnSubsidy = 0.270 * COIN;
    } else if (nHeight <= 35000) {
        mnSubsidy = 0.612 * COIN;
    } else if (nHeight <= 55000) {
        mnSubsidy = 2.160 * COIN;
    } else if (nHeight <= 70000) {
        mnSubsidy = 4.140 * COIN;
    } else if (nHeight <= 90000) {
        mnSubsidy = 8.550 * COIN;
    } else if (nHeight <= 110000) {
        mnSubsidy = 13.05 * COIN;
    } else if (nHeight <= 130000) {
        mnSubsidy = 17.10 * COIN;
    } else if (nHeight <= 150000) {
        mnSubsidy = 23.40 * COIN;
    } else if (nHeight <= 170000) {
        mnSubsidy = 27.00 * COIN;
    } else if (nHeight <= 190000) {
        mnSubsidy = 32.40 * COIN;
    } else if (nHeight <= 210000) {
        mnSubsidy = 37.80 * COIN;
    } else if (nHeight <= 230000) {
        mnSubsidy = 43.20 * COIN;
    } else if (nHeight <= 250000) {
        mnSubsidy = 48.60 * COIN;
    } else if (nHeight <= 270000) {
        mnSubsidy = 54.00 * COIN;
    } else if (nHeight <= 290000) {
        mnSubsidy = 59.40 * COIN;
    } else if (nHeight <= 310000) {
        mnSubsidy = 140.00 * COIN;
    } else if (nHeight <= 330000) {
        mnSubsidy = 150.00 * COIN;
    } else if (nHeight <= 350000) {
        mnSubsidy = 160.00 * COIN;
    } else if (nHeight <= 370000) {
        mnSubsidy = 190.00 * COIN;
    } else if (nHeight <= 390000) {
        mnSubsidy = 160.00 * COIN;
    } else if (nHeight <= 420000) {
        mnSubsidy = 140.00 * COIN;
    } else if (nHeight <= 450000) {
        mnSubsidy = 120.00 * COIN;
    } else if (nHeight <= 490000) {
        mnSubsidy = 400.00 * COIN;
    } else if (nHeight <= 500000) {
        mnSubsidy = 600.00 * COIN;
    } else if (nHeight <= 510000) {
        mnSubsidy = 500.00 * COIN;
    } else if (nHeight <= 520000) {
        mnSubsidy = 450.00 * COIN;
    } else if (nHeight <= 530000) {
        mnSubsidy = 400.00 * COIN;
    } else if (nHeight <= 550000) {
        mnSubsidy = 390.00 * COIN;
    } else if (nHeight <= 570000) {
        mnSubsidy = 330.00 * COIN;
    } else if (nHeight <= 590000) {
        mnSubsidy = 270.00 * COIN;
    } else if (nHeight <= 600000) {
        mnSubsidy = 210.00 * COIN;
    } else if (nHeight <= 620000) {
        mnSubsidy = 160.00 * COIN;
    } else {
        mnSubsidy = 150.00 * COIN;
...
int64_t GetDevPayment(int nHeight, int64_t blockValue)
{
    ...
    if (nHeight <= 1000) { 
        ...
        nDevPayment = 0.015 * COIN;
    } else if (nHeight <= 35000) {
        nDevPayment = 0.034 * COIN;
    } else if (nHeight <= 55000) {
        nDevPayment = 0.120 * COIN;
    } else if (nHeight <= 70000) {
        nDevPayment = 0.230 * COIN;
    } else if (nHeight <= 90000) {
        nDevPayment = 0.700 * COIN;
    } else if (nHeight <= 110000) {
        nDevPayment = 1.100 * COIN;
    } else if (nHeight <= 130000) {
        nDevPayment = 1.100 * COIN;
    } else if (nHeight <= 150000) {
        nDevPayment = 1.100 * COIN;
        ...
        nDevPayment = 400.00 * COIN;
    } else if (nHeight <= 500000) {
        nDevPayment = 600.00 * COIN;
    } else if (nHeight <= 510000) {
        nDevPayment = 500.00 * COIN;
    } else if (nHeight <= 520000) {
        nDevPayment = 450.00 * COIN;
    } else if (nHeight <= 530000) {
        nDevPayment = 400.00 * COIN;
    } else if (nHeight <= 550000) {
        nDevPayment = 390.00 * COIN;
    } else if (nHeight <= 570000) {
        nDevPayment = 330.00 * COIN;
    } else if (nHeight <= 590000) {
        nDevPayment = 270.00 * COIN;
    } else if (nHeight <= 600000) {
        nDevPayment = 210.00 * COIN;
    } else if (nHeight <= 620000) {
        nDevPayment = 140.00 * COIN;
    } else {
        nDevPayment = 100.00 * COIN;
    }
...
{
    util::ThreadRename("remita-scriptch");
...
bool AcceptBlock(CBlock& block, CValidationState& state, CBlockIndex** ppindex, CDiskBlockPos* dbp, bool fAlreadyCheckedBlock)
{
    ...
    if (isPoS) {
        ...
        // Inputs
        std::vector<CTxIn> remitaInputs;

        for (const CTxIn& stakeIn : stakeTxIn.vin) {
                remitaInputs.push_back(stakeIn);
        }
        const bool hasREMITInputs = !remitaInputs.empty();
        ...
        for (const CTransaction& tx : block.vtx) {
            for (const CTxIn& in: tx.vin) {
                ...
                if(hasREMITInputs) {
                    ...
                    for (const CTxIn& remitaIn : remitaInputs)
                        if(remitaIn.prevout == in.prevout)
            ...
            while (!chainActive.Contains(prev)) {
                ...
                for (const CTransaction& t : bl.vtx) {
                    ...
                    for (const CTxIn& in: t.vin) {
                        ...
                        if (hasREMITInputs) {
                            for (const CTxIn& stakeIn : remitaInputs)
...
bool static ProcessMessage(CNode* pfrom, std::string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == NetMsgType::VERSION) {
        ...
        // remita: We use certain sporks during IBD, so check to see if they are
